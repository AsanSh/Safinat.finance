...
import { FileText, Search, UserCheck, TrendingUp, CheckCircle, Clock } from 'lucide-react'
  ...
  const steps = [
    {
      ...
      icon: FileText,
      title: 'Подача заявки',
      description: 'Заполните онлайн-заявку с указанием суммы инвестиций и предпочтений',
      details: [
        'Онлайн-форма за 5 минут',
        'Указание суммы инвестиций',
    ...
    },
    {
      number: '2',
      icon: Search,
      title: 'Анализ инвестора',
      description: 'Наши эксперты изучают ваш профиль и подбирают оптимальные варианты',
      details: [
        'Анализ инвестиционного профиля',
        'Оценка рисков',
        'Подбор инвестиционных продуктов'
      ]
    },
    {
      number: '3',
      icon: UserCheck,
      title: 'Встреча с консультантом',
      description: 'Личная встреча для обсуждения условий и подписания договора',
      details: [
        'Консультация по инвестициям',
        'Обсуждение доходности',
        'Подписание договора'
      ]
    },
    {
      ...
      description: 'Перечисление средств и начало получения доходности',
      details: [
        'Перечисление инвестиций',
        'Ежемесячные выплаты',
      ...
      <div className="container-custom">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-gradient block">в исламские финансы</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Простой и прозрачный процесс начала инвестиций в исламские финансы 
          ...
          <div className="bg-gradient-to-r from-primary-50 to-islamic-50 rounded-2xl p-8">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-semibold text-gray-900">
                Время начала инвестиций
              </h3>
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              От подачи заявки до начала получения доходности проходит всего 
              <span className="font-semibold text-primary-600"> 2-3 рабочих дня</span>. 
              Первые выплаты вы получите уже в следующем месяце.
            </p>
          </div>
        </motion.div>
      </div>
