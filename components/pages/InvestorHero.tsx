  ...
  const features = [
    {
      ...
      description: 'Гарантированная прибыль от 15% до 25% годовых'
    },
    {
      icon: Shield,
      title: 'Безопасность инвестиций',
      description: 'Все инвестиции застрахованы и защищены'
    },
    {
      icon: Users,
      title: 'Экспертное управление',
      description: 'Профессиональная команда управляет вашими средствами'
    },
    {
      icon: Award,
      title: 'Соответствие шариату',
      description: '100% соответствие исламским принципам инвестирования'
    }
  ]
        ...
        <div className="text-center mb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Инвестиции в исламские
              <span className="text-gradient block">финансы</span>
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-4xl mx-auto mb-8 leading-relaxed">
              Станьте инвестором в исламские финансы и получайте стабильную доходность 
              от 15% до 25% годовых. Все инвестиции соответствуют принципам шариата 
              и управляются профессиональной командой.
            </p>
