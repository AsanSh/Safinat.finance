...
const IslamicProducts = () => {
  ...
  const products = [
    {
      icon: Home,
      title: 'Мурабаха для недвижимости',
      description: 'Приобретение жилой и коммерческой недвижимости в соответствии с принципами шариата',
      minAmount: 500000,
      maxAmount: 50000000,
      term: '6-60 месяцев',
      rate: '12-18%',
    ...
    {
      icon: Building2,
      title: 'Финансирование строительства',
      description: 'Поддержка строительных проектов через исламские финансовые инструменты',
      minAmount: 1000000,
      maxAmount: 100000000,
      term: '12-84 месяца',
      rate: '14-20%',
    ...
    {
      icon: Car,
      title: 'Автомобильное финансирование',
      description: 'Приобретение автомобилей для личного и коммерческого использования',
      minAmount: 200000,
      maxAmount: 10000000,
      term: '6-48 месяцев',
      rate: '15-22%',
    ...
    {
      icon: Briefcase,
      title: 'Бизнес-финансирование',
      description: 'Поддержка малого и среднего бизнеса через исламские принципы',
      minAmount: 300000,
      maxAmount: 20000000,
      term: '6-36 месяцев',
      rate: '16-24%',
        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/sharia-compliance" className="btn-primary">
                Узнать о шариатском соответствии
              </a>
